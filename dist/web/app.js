...
(() => {
  ...
  var require_browser_platform = __commonJS({
    "src/platform/browser-platform.js"(exports, module) {
      "use strict";
      var { PlatformPort } = require_platform_port();
      var BrowserPlatform2 = class extends PlatformPort {
        constructor(canvas2) {
          super();
          this.canvas = canvas2;
        }
        ...
        onPointer(listener) {
          ...
          const adapt = (type) => (event) => {
            ...
            if (type === "start") (_b = (_a = this.canvas).setPointerCapture) == null ? void 0 : _b.call(_a, event.pointerId);
        ...
        vibrate(kind = "light") {
          ...
          try {
            return !!((_a = navigator.vibrate) == null ? void 0 : _a.call(navigator, duration));
          } catch {
            return false;
          }
        }
        log(level, event, data) {
          (console[level] || console.log)(`[grow-fish] ${event}`, data || "");
        }
      };
      module.exports = { BrowserPlatform: BrowserPlatform2 };
    }
  });
        ...
        consumeEvents(events, snapshot) {
          ...
          for (const event of events) {
            ...
            if (event.type === "game_start" || event.type === "game_quit") {
              ...
              this.addEffect({ kind: "score", x: (_a = data.x) != null ? _a : snapshot.player.x, y: (_b = data.y) != null ? _b : snapshot.player.y, text: `+${data.points}`, color: event.type === "fish_eaten" ? "#fff1a8" : "#9fffd2", age: 0, life: 0.6 });
      ...
      var AudioManager = class {
        ...
        unlock() {
          ...
          try {
            ...
            const operation = (_b = (_a = this.context) == null ? void 0 : _a.resume) == null ? void 0 : _b.call(_a);
        ...
        stopAmbient() {
          var _a, _b;
          try {
            (_b = (_a = this.ambient) == null ? void 0 : _a.oscillator) == null ? void 0 : _b.stop();
          } catch {
          }
          this.ambient = null;
        }
        ...
        suspend() {
          var _a, _b;
          try {
            this.observeOperation((_b = (_a = this.context) == null ? void 0 : _a.suspend) == null ? void 0 : _b.call(_a));
          } catch {
          }
        }
        resumePaused() {
          var _a, _b;
          try {
            this.observeOperation((_b = (_a = this.context) == null ? void 0 : _a.resume) == null ? void 0 : _b.call(_a), () => {
              this.unlocked = false;
              this.stopAmbient();
              this.stopVoices();
            });
    ...
    "src/debug/test-harness.js"(exports, module) {
      ...
      var TestHarness = class {
        ...
        spawnFish(options = {}) {
          ...
          fish.x = (_a = options.x) != null ? _a : this.core.player.x;
        ...
        spawnGrass(options = {}) {
          const grass = this.core.grassPool.acquire((item) => {
            var _a, _b;
            item.active = true;
            item.x = (_a = options.x) != null ? _a : this.core.player.x;
  ...
  var { BrowserPlatform } = require_browser_platform();
  var { GameApp } = require_game_app();
  var canvas = document.getElementById("game");
  if (!canvas) throw new Error("Missing #game canvas");
  var platform = new BrowserPlatform(canvas);
